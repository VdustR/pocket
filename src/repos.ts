...
const repos: Repo[] = [
  ...
  },
  {
    ...
    description: "✅ The Node.js best practices list (June 2022)",
  ...
  },
  {
    owner: "master-co",
    name: "css",
    description: "A Virtual CSS language with enhanced syntax ~14KB",
  ...
  { owner: "tedmax100", name: "blog", description: "", homepage: "", tags: [] },
  {
    owner: "Templarian",
    name: "MaterialDesign",
    description: "✒6700+ Material Design Icons from the Community",
