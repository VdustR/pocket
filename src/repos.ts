...
const repos: Repo[] = [
  ...
  },
  {
    ...
    name: "gh-net",
    description:
      "GitHub CLI extension that allows to bridge network between a Codespace and a local machine.",
  ...
  },
  {
    owner: "Gogh-Co",
    name: "Gogh",
    description: "Color Scheme for Gnome Terminal and Pantheon Terminal",
  ...
  },
  {
    ...
    description: "✅ The Node.js best practices list (March 2022)",
  ...
  },
  {
    owner: "nhost",
    name: "nhost",
    description: "The Open-Source GraphQL Backend (Firebase Alternative).",
  ...
  },
  {
    ...
    name: "tamagui",
    description:
      "Faster, more intuitive design systems that work on React Native + React Native Web with an optimizing compiler.",
  ...
  },
  {
    ...
    description: "Local Movies Metadata Scraper",
    homepage: "",
    tags: [
      "adult-video",
      "emby",
