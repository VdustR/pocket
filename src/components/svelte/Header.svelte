    ...
    <div class="flex items-center justify-between">
      <div class="flex items-center gap-4">
        <a href="/pocket/" class="flex items-center gap-2 hover:opacity-80 transition-opacity group">
          ...
          <h1 class="text-2xl font-cursive text-primary-600 dark:text-primary-400 dark:drop-shadow-[0_0_10px_rgba(6,182,212,0.3)]">
            ViPro's Picks
          </h1>
        </a>
      </div>
      ...
      <div class="flex items-center gap-2">
        ...
        >
          <Icon
            icon={showDashboard ? "ph:list-bold" : "ph:chart-pie-bold"}
            class="w-5 h-5"
          />
        </button>
